...
import com.mco.pc_store.core.domain.request.TokenReq;
...
//    private static final long USER_ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 365 * 5; // 5 년 처리  ==> Long 처리 안됨
//    private static final long USER_REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 365 * 10;  // 10 년 처리 == Long 처리 안됨
    ...
    public AuthTokenVO generateTokenDto(Authentication authentication, int userAuth, String type,
        TokenReq token) {
        //AccessToken 생성
